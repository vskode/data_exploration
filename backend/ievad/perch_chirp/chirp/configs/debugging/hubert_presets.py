...
from ievad.perch_chirp.chirp.configs import hubert_presets as hubert_presets_default
from ievad.perch_chirp.chirp.configs.debugging import presets as presets_debug
